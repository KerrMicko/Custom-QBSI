...
{
    public class Queries_Enclosure
    {
        public List<InvoiceData> GetInvoiceData(string refNumber)
        {
            ...
            try
            {
                using (OleDbConnection connection = new OleDbConnection(accessConnectionString))
                {
                    ...
                    string invoiceQuery = "SELECT CustomFieldTIN, CustomFieldDRNO, CustomFieldJOBORDERNO, CustomFieldPWDNO, CustomerRefFullName, CustomFieldBUSINESSSTYLE, CustomFieldSTORECODE, CustomFieldSONO, PONumber, " +
        ...
        public void UpdateSignatory(string preparedBy, string checkedBy, string approvedBy)
        {
            ...
            try
            {
                using (OleDbConnection connection = new OleDbConnection(accessConnectionString))
                {
                    ...
                    string updateQuery = "UPDATE Signatory_Enclosure SET PreparedBy = ?, CheckedBy = ?, ApprovedBy = ? WHERE ID = 1";
        ...
        public (string preparedBy, string checkedBy, string approvedBy) RetrieveSignatory()
        {
            ...
            using (OleDbConnection connection = new OleDbConnection(accessConnectionString))
            {
                ...
                string selectQuery = "SELECT PreparedBy, CheckedBy, ApprovedBy FROM Signatory_Enclosure WHERE ID = 1";
