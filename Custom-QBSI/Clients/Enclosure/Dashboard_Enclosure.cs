...
{
    public class Dashboard_Enclosure
    {
            ...
            button_SearchRefNum.Click += (sender, e) =>
            {
                try
                {
                    ...
                    else if (comboBox_Forms.SelectedIndex != 0 && textBox_ReferenceNumber.Text != "")
                    {
                        ...
                        Layout_Enclosure layout_Enclosure = new Layout_Enclosure();
        ...
        private FlowLayoutPanel Panel_Signatory()
        {
            ...
            var signatory = queries_Enclosure.RetrieveSignatory();
            ...
            {
                queries_Enclosure.UpdateSignatory(
