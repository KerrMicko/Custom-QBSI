...
namespace Custom_QBSI.Clients.IVP
{
    public class Dashboard_IVP
    {
        ...
        private FlowLayoutPanel Main_PanelDetails()
        {
            ...
            var detailedIVP = queries_IVP.RetrieveACNoAndDateIssued();
            if (!string.IsNullOrEmpty(detailedIVP.acNo))
            {
                textBox_ACNo.Text = detailedIVP.acNo;
            }
            if (detailedIVP.dateIssued.HasValue)
            {
                dateTimePicker_DateIssued.Value = detailedIVP.dateIssued.Value;
            }
            ...
            {
                queries_IVP.UpdateACNoAndDateIssued(
                  textBox_ACNo.Text,
        ...
        private FlowLayoutPanel Panel_Signatory()
        {
            ...
            var signatory = queries_IVP.RetrieveSignatory();
